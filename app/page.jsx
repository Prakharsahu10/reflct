    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-t from-orange-50 via-transparent to-transparenmt pointer-events-none z-10" />
          ...
          <CardContent className="p-12 text-center">
            ...
            <Link href="/dashboard">
              <Button size="lg" variant="journal" className="animate-bounce">
                Get Started for Free <ChevronRight className="ml-24 h-4 w-4" />
              </Button>
            </Link>
          </CardContent>
        </Card>
